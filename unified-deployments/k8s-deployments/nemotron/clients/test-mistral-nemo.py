#!/usr/bin/env python3
"""
Test client for Mistral-Nemo-Instruct-2407 model.
An efficient 12B model with good performance for general tasks.

Usage:
    python test-mistral-nemo.py
    python test-mistral-nemo.py --prompt "Summarize the benefits of cloud computing"
    python test-mistral-nemo.py --stream
"""
...
def main():
    parser = argparse.ArgumentParser(description="Test Mistral-Nemo-Instruct model")
    parser.add_argument("--prompt", "-p", type=str, 
                        default="What are three interesting facts about the planet Mars?",
                        help="Prompt to send to the model")
    parser.add_argument("--system", "-sys", type=str,
                        default="You are a knowledgeable and helpful assistant.",
                        help="System prompt")
    ...
    print(f"🌟 Mistral-Nemo-Instruct Test Client")
